...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.selfmade.better.service.EmailAlreadyUsedException ||
            ex instanceof com.selfmade.better.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.selfmade.better.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.selfmade.better");
    }
}
